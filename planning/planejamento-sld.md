...
## Tasks Pendentes para Lançamento

As tasks abaixo seguem o template de `estrutura-task.md` e representam o trabalho restante para atingir a versão 1.0.
...
**Total: 24 pontos em 5 tasks restantes para v1.0**
